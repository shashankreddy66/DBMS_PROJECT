-- Placement Management System Database Schema (MySQL Version)
...
CREATE TABLE Applications (
    ...
    JobID INT NOT NULL,
    Status VARCHAR(50) NOT NULL DEFAULT 'Applied', -- E.g., 'Applied', 'Shortlisted', 'Interviewing', 'Selected', 'Rejected'
...
-- Note: MySQL command line output standard format
